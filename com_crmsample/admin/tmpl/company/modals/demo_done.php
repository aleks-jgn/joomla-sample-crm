...
?>
<div class="modal fade" id="modal-demo_done" tabindex="-1" aria-labelledby="modal-demo_done-label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-demo_done-label"><?php echo Text::_('COM_CRMSAMPLE_ACTION_DEMO_DONE'); ?></h5>
            ...
            <form action="<?php echo Route::_('index.php?option=com_crmsample&task=company.addEvent'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="link" class="form-label"><?php echo Text::_('COM_CRMSAMPLE_LINK'); ?></label>
                        <input type="url" class="form-control" id="link" name="event_data[link]" placeholder="https://...">
                    </div>
                    <div class="mb-3">
