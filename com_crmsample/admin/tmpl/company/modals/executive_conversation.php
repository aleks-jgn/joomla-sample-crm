...
?>
<div class="modal fade" id="modal-executive_conversation" tabindex="-1" aria-labelledby="modal-executive_conversation-label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-executive_conversation-label"><?php echo Text::_('COM_CRMSAMPLE_ACTION_EXECUTIVE_CONVERSATION'); ?></h5>
            ...
            <form action="<?php echo Route::_('index.php?option=com_crmsample&task=company.addEvent'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="event_type" value="executive_conversation">
                    <div class="mb-3">
